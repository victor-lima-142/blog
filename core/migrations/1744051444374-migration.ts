...
export class Migration1744051444374 implements MigrationInterface {
    name = 'Migration1744051444374'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "blog"."article_tag" ("id" BIGSERIAL NOT NULL, "articleId" bigint, "tagId" bigint, CONSTRAINT "PK_43dc2fa69a4739ce178e021d649" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "blog"."article_tag" ADD CONSTRAINT "FK_602d4921b27c9a7cb6c095992b4" FOREIGN KEY ("articleId") REFERENCES "blog"."articles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "blog"."article_tag" ADD CONSTRAINT "FK_bbbd0832bdd107597b596d63f69" FOREIGN KEY ("tagId") REFERENCES "blog"."tags"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "blog"."article_tag" DROP CONSTRAINT "FK_bbbd0832bdd107597b596d63f69"`);
        await queryRunner.query(`ALTER TABLE "blog"."article_tag" DROP CONSTRAINT "FK_602d4921b27c9a7cb6c095992b4"`);
