...
export class Migration1744918086271 implements MigrationInterface {
    name = 'Migration1744918086271'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "blog"."comments" ("id" BIGSERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "content" text NOT NULL, "articleId" bigint, "commentId" bigint, "authorId" bigint, CONSTRAINT "PK_8bf68bc960f2b69e818bdb90dcb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "blog"."comments" ADD CONSTRAINT "FK_b0011304ebfcb97f597eae6c31f" FOREIGN KEY ("articleId") REFERENCES "blog"."articles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "blog"."comments" ADD CONSTRAINT "FK_b302f2e474ce2a6cbacd7981aa5" FOREIGN KEY ("commentId") REFERENCES "blog"."comments"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "blog"."comments" DROP CONSTRAINT "FK_b302f2e474ce2a6cbacd7981aa5"`);
